...
10. Optional LLM planner runs behind an adapter and schema validation.
11. The app renders a Block Kit Incident Control Room with an Evidence Ledger in the thread.
